...
function casdenom(denom1, denom2) {
    ...
    if (denom1 != 1 && denom2 != 1 && denom2 != 0) {
        rep = 0;
    }
    if (denom1 == 1 && denom2 == 0) {
        rep = 5;
    }
    return rep;
}
...
let soluce, a, b, c, d, e, f, signe1, signe2, signe3, signe4, signe5, signe6, signe7, signe8, signe9, somx, somreels, signe10, s2, s10, bsigne, asigne, somreelsigne, rep1, rep2, rep1simp, rep2simp, imporep1, imporep2, sfrac1, sfrac2, abssomreels, abssomx, frac1simp, frac2simp, a1, b1, somreels1, repsimp1, repsimp2, k;
...
function genererExercice() {
    ...
    soluce = [`$S=\\left\\{${sfrac1}\\dfrac{${frac1simp[0]}}{${frac1simp[1]}}~;~${sfrac2} \\dfrac{${frac2simp[0]}}{${frac2simp[1]}}\\right\\}$`,
